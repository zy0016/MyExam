...
int DispMid(TreeNode* &t);
int Disp(TreeNode* &t);
int DispBehid(TreeNode* &t);
...
int testmytree3_1() {
	...
	int imid = DispMid(T);
	cout <<"\tcount:"<<imid<< endl;

	cout << "post order:" << endl;
	Posorder(T);
	cout << endl;
	int ibehid = DispBehid(T);
	cout <<"\tcount:"<<ibehid << endl;

	cout << "tree height:"<< get_height(T) << endl;
	return 1;
}
//先序遍历非递归算法
int Disp(TreeNode* &t)
